...
int main(int argc, char* argv[]) {
    ...
    //
    // NOTE: 服务器驱动原因会卡死，暂时跳过
    // =========================================================================
    print_sep("3e. CuTe SM90: PingPong Cluster (SKIPPED - driver issue)");
    printf("SKIP: Section 3e disabled (causes hang on this server due to driver issue)\n");
