...
struct Hstu_params {
  ...
  index_t k_row_stride; // head*headdim
  index_t v_row_stride; // head*headdim
...
struct Hstu_fwd_params : public Hstu_params {
  ...
  // M-folcon params
  bool is_mfalcon;
  int*__restrict__ user_length; //from cuda tensor
  int*__restrict__ target_length; //from cuda tensor
  int*__restrict__ micro_bs; // from cuda tensor
