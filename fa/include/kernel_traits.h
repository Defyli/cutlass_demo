...
template <
    ...
    typename Base =
        Flash_kernel_traits<kHeadDim_, kBlockM_, kBlockN_, kNWarps_, elem_type>>
struct Mfalcon_fwd_kernel_traits : public Base {
    static constexpr bool Is_delta_q = false;
    static constexpr bool Is_causal = false;
    static constexpr bool Is_target = false;
    static constexpr bool Is_context = false;
    static constexpr bool Is_local = false;
    static constexpr bool Has_rab = Has_rab_; // Assume RAB might be used
    static constexpr bool Paged_KV = false;
    static constexpr bool Is_balance = false;
    static constexpr bool Has_mask = Has_mask_;
    static constexpr bool Is_even_rab = Is_even_rab_;
    static constexpr bool Is_mfalcon = true;
    static constexpr bool Share_Q_K_smem = Has_mask_ || kHeadDim_ <= 128; // for m-falcon/ dynamic mask 
    static constexpr bool Is_Q_in_regs = kHeadDim_ <= 128 || Share_Q_K_smem;
    ...
    static constexpr int kSmemQSize = size(SmemLayoutQ{}) * sizeof(Element);
    static constexpr int kSmemRabSize = Has_rab ? size(SmemLayoutRab{}) * sizeof(Element) : 0;
    static constexpr int kSmemMaskSize = Has_mask ? size(SmemLayoutMask{}) * sizeof(Element) : 0;
    static constexpr int kSmemKVSize = size(SmemLayoutKV{}) * 2 * sizeof(Element);
    static constexpr int kSmemSizeQKV = Share_Q_K_smem
                                            ? std::max(kSmemQSize, kSmemKVSize)
                                            : kSmemQSize + kSmemKVSize;
    static constexpr int kSmemSize = kSmemSizeQKV + kSmemRabSize + kSmemMaskSize;
...
template <
    ...
    typename Base =
        Flash_kernel_traits<kHeadDim_, kBlockM_, kBlockN_, kNWarps_, elem_type>>
struct fwdMask_kernel_traits : public Base {
    static constexpr bool Is_delta_q = false;
    static constexpr bool Is_causal = false;
    static constexpr bool Is_target = false;
    static constexpr bool Is_context = false;
    ...
    static constexpr bool Is_even_rab = Is_even_rab_;
    static constexpr bool Share_Q_K_smem = true; // for m-falcon/ dynamic mask 
    static constexpr bool Is_Q_in_regs = true;
    static constexpr int User_len = User_len_;
